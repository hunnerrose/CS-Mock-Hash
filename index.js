...
checkPassword = async (username, plaintextPassword) => {
    ...
    if (globalStore[username]) {
        ...
        if (result) {
            ...
            console.log(`Welcome back, ${username}, you're a valid user!`)
        }
        else {
            // TODO: Display message for invalid credentials
            console.log(`I don't recognize you! Get ou!`)
        }
    }
    else {
...
hashPassword = async (username, password) => {
    ...
    console.log(`Great! Your username ${username} and password ${pwHash} have been registered to the database.`)
}
